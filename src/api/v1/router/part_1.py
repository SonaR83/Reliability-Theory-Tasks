...
from tasks.part_1.solution_part_1 import task1, task2, task3, task4, task5, task6, \
    task7, task8
...
@part_1.post("/part_1_task_6", description="Task 6", response_class=ORJSONResponse)
...
@part_1.post("/part_1_task_7", description="Task 7", response_class=ORJSONResponse)
async def part_1_task_6(file_bytes: bytes = File(), ) -> ORJSONResponse:
...
@part_1.post("/part_1_task_8", description="Task 8", response_class=ORJSONResponse)
async def part_1_task_6(file_bytes: bytes = File(), ) -> ORJSONResponse:
